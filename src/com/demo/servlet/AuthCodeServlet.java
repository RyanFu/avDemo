...
/**
 * Authentication code for register/login. The code would be store in session and its key is
 * 'authCode'.
 * 
 * 
 * 
...
public class AuthCodeServlet extends HttpServlet {
  ...
  /**
   * With of authentication image
   */
  private int width = 60;
  /**
   * Height of authentication image
   */
  private int height = 20;

  /**
   * Count of authentication character
   */
